...
class Rectangle(Base):
    ...
    def __init__(self, width, height, x=0, y=0, id=None):
        ...
        Args:
            ...
            x (int): This is the x coordinate of the new rectangle
            y (int): This is the y coordinate of the new rectangle
            id (int): This is the identity of the new rectangle
    ...
    def display(self):
        ...
        for i in range(self.height): #changed h to i
