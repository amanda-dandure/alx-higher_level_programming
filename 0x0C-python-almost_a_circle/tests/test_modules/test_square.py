#!/usr/bin/python3
""" Defining unittest for the models/square.py

Unittest classes:
    testSquare_instantiation: Line 23 - 84
    testSquare_size: Line 87 - 161
    testSquare_x: Line 163 - 233
    testSquare_y: Line 236 - 301
    testSquare_order_of_initialization: Line 304 - 317
    testSquare_area: Line 320 - 338
    TestSquare_stdout: Line 341 - 422
    testSquare_update_args: Line 425 - 534
    testSquare_update_kwargs: Line 537 - 636
    testSquare_to_dictionary: Line 639 - 656
"""
import io
import sys
import unittest
...
class testSquare_instantiation(unittest.TestCase):
    """ Unittest to test the instantiation of the square class """
...
class testSquare_size(unittest.TestCase):
    """ Unittest to test size initialization of the square class """
...
class testSquare_x(unittest.TestCase):
    """ Unittest to test the initialization of the Square x attr """
...
class testSquare_y(unittest.TestCase):
    """ Unittest to test the initialization of square y-attr """
...
class testSquare_order_of_initialization(unittest.TestCase):
    """ Unittest for testing the order of the square attr initialization """
...
class testSquare_area(unittest.TestCase):
    """ Unittest to test the area method of the square class """
...
class TestSquare_stdout(unittest.TestCase):
    """ Unittest to test __str__ and display methods of square class """

    @staticmethod
    def capture_stdout(sq, method):
        """ Capturing and returning the text printed to stdout

        Args:
            sq (Square): This is the square to print to the stdout.
            method (str): This is the method to run on sq
        Returns:
            The text be printed to stdout by calling method on sq
        """
        capture = io.StringIO()
        sys.stdout = capture
        if method == "print":
...
class testSquare_update_args(unittest.TestCase):
    """ Unittest for testing the update args method of the square class """
...
class testSquare_update_kwargs(unittest.TestCase):
    """ Unittest for testing the update kwargs method of square class """
...
class testSquare_to_dictionary(unittest.TestCase):
    """ Unittest to test the to_dictionary method of the square class """
