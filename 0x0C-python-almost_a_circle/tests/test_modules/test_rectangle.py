...
class testRectangle_instantiation(unittest.TestCase):
    """ Unittest to test instantiation of the rectangle class """
...
class TestRectangle_stdout(unittest.TestCase):
    ...
    def capture_stdout(rect, method):
        ...
        Args:
            rect (Rectangle): This is the rectangle to print to the stdout
            method (str): This is the method to run on the rectangle
        Returns:
